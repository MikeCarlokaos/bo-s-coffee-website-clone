...
import coffeeSubscriptions from "../../components/data/pages/coffeeSubscriptions";
import CoffeeSubscriptionCard from "./CoffeeSubscriptionCard";
import { useState } from "react";

const CoffeeSubsription = () => {
  ...
  const SubscriptionSelection = coffeeSubscriptions.map((coffeeSub) => {
    return <CoffeeSubscriptionCard key={coffeeSub.id} {...coffeeSub} />;
  });
...
export default CoffeeSubsription;
