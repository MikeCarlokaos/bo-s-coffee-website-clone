...
import bakedGoods from "../../components/data/pages/bakedGoods";
import BakedGoodsCard from "./BakedGoodsCard";
...
const BakedGoods = () => {
  ...
  const BakedSelection = bakedGoods.map((baked) => {
    return <BakedGoodsCard key={baked.id} {...baked} />;
  });
