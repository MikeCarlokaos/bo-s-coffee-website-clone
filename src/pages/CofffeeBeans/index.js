...
import coffeeBeans from "../../components/data/pages/coffeeBeans";
...
const CoffeeBeans = () => {
  ...
  const CoffeeSelection = coffeeBeans.map((coffeeBean) => {
    return <CoffeeCard key={coffeeBean.id} {...coffeeBean} />;
  });
  return (
